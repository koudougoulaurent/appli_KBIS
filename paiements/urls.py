...
urlpatterns = [
    ...
    # Téléchargement quittance PDF KBIS pour reliquat ou paiement partiel
    path('telecharger-quittance-kbis-pdf/<int:paiement_id>/', views.telecharger_quittance_kbis_pdf, name='telecharger_quittance_kbis_pdf'),
    ...
    path('historique/', include('paiements.urls_historique')),
