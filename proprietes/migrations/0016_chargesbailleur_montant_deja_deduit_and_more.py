...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='Montant déjà déduit des retraits'),
        ),
        migrations.AddField(
            model_name='chargesbailleur',
            name='montant_restant',
            field=models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='Montant restant à déduire'),
        ),
        migrations.AlterField(
            model_name='chargesbailleur',
            name='statut',
            field=models.CharField(choices=[('en_attente', 'En attente'), ('payee', 'Payée'), ('remboursee', 'Remboursée'), ('deduite_retrait', 'Déduite du retrait mensuel'), ('annulee', 'Annulée')], default='en_attente', max_length=20, verbose_name='Statut'),
        ),
        migrations.AlterField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('montant_deduit', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Montant déduit de ce retrait')),
                ...
                ('charge_bailleur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='retraits_lies', to='proprietes.chargesbailleur', verbose_name='Charge bailleur')),
                ('retrait_bailleur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='charges_bailleur_liees', to='paiements.retraitbailleur', verbose_name='Retrait bailleur')),
            ],
            options={
