    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groupe', models.CharField(choices=[('privilege', 'Privilège'), ('administration', 'Administration'), ('caisse', 'Caisse'), ('controle', 'Contrôle')], default='controle', max_length=20, verbose_name='Groupe de permissions')),
                ('est_actif', models.BooleanField(default=True, verbose_name='Utilisateur actif')),
